...
python3 /HPS/deep_topopt/work/topopt-fourfeat-3d/training/train_voxelfem.py --jid ${SLURM_JOBID} --grid "[320, 160, 80]" --prob "problems/3d/bridge.json" --mgl 3 --iter 5000 --optim "OC" --v0 "0.4"
