...
python3 /HPS/deep_topopt/work/topopt-fourfeat-3d/training/train_xdg.py --jid ${SLURM_JOBID} --grid "[320, 160, 80]" --prob "problems/3d/bridge.json" --mgl 3 --iter 5000 --v0 "0.4" --es 1024 --nn 512 --nl 4 --sigma 2.5 --cs 100
